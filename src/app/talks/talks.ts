      ...
      <div class="page">
        ...
        <div class="row">
          ...
          <div class="col-md-8 talks">
            <div class="row">
              <div class="col-md-4">
                <profile name="Tracy Lee" twitter="ladyleet" image="/assets/img/organisers/tracy-lee.jpg">
                  Host
                </profile>
              </div>      
              <div class="col-md-4">
                <profile name="Joe Eames" twitter="josepheames" image="/assets/img/organisers/joe-eames.jpeg">
                  Panel Moderator
                </profile>
              </div>
              <div class="col-md-4">
                <profile name="Gerard Sans" twitter="gerardsans" image="/assets/img/organisers/gerard-sans.jpg">
                  Panel Moderator
                </profile>
              </div>
            </div>
            <talk name="Jeff Cross" twitter="jeffbcross" tags="" tittle="Keynote" image="/assets/img/speakers/jeff_cross.jpg">
            </talk>
            <talk name="Victor Savkin" twitter="victorsavkin" tags="" tittle="Keynote" image="/assets/img/speakers/victor_savkin.jpg">
            </talk>
            <talk name="Ben Lesh" twitter="BenLesh" tags="RxJS; Angular 2" tittle="RxJS By Example" image="/assets/img/speakers/ben_lesh.jpg">
            ...
            <talk name="Aaron Frost" twitter="js_dev" tags="Components" tittle="CaaS: Components as a Service" image="/assets/img/speakers/aaron_frost.jpg">
            ...
            <talk name="Mike Brocchi" twitter="Brocco" tags="Angular CLI" tittle="Angular CLI" image="/assets/img/speakers/mike_brocchi.jpg">
            ...
            <talk name="Alyssa Nicoll" twitter="AlyssaNicoll" tags="Animations; CSS" tittle="Animations in an Angular World" image="/assets/img/speakers/alyssa_nicoll.jpg">
